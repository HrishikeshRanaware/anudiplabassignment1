...
public class Marks {
	...
	public static void main(String[] args) {
		...
		stud.add(new StudentInfo (1,"Prajakta",22,75));
		stud.add(new StudentInfo (2,"prerna",22,79));
		stud.add(new StudentInfo (3,"ashutosh",24,80));
		stud.add(new StudentInfo (4,"omkar",21,86));
		stud.add(new StudentInfo (5,"mayuri",22,58));
		stud.add(new StudentInfo (6,"gajanan",22,60));
