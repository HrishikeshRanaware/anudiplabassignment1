...
public class Studentmain{
	...
	public static void main(String[] args) {
		...
		stud.add(new Student(1,"prajakta",22,75));
		stud.add(new Student(2,"prerna",22,79));
		stud.add(new Student(3,"Gajanan",24,80));
		stud.add(new Student(4,"Ashutosh",21,86));
		stud.add(new Student(5,"Mayuri",22,58));
